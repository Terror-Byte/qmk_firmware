 ...
 */
 [_COLEMAK] = LAYOUT(
  ...
  KC_TRNS,  LCTL_T(KC_Z), LALT_T(KC_X), KC_C,     KC_D, 	   KC_V,  KC_LBRC,  KC_RBRC, KC_K,	  KC_H, 	 KC_COMM, KC_DOT,  RCTL_T(KC_SLASH), KC_TRNS,
                                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,	KC_TRNS, KC_TRNS, KC_TRNS, DF(_QWERTY)
 ),
